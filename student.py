...
class Student:
    def __init__(self,root):
        ...
        main_frame.place(x=25,y=180,width=1480,height=600)

        #left label frame
        Left_frame = LabelFrame(main_frame,bd=2,relief=RIDGE,text="Student Details",font=("times new roman",12,"bold"))
        Left_frame.place(x=10,y=10,width=720,height=580)

        img_left = Image.open(r"C:\Program Files\Python311\face_Detaction_project\Images\stdtl.jpeg")
        ...
        current_course_frame.place(x=5,y=135,width=710,height=150)
        ...
        dep_combo["values"]=("Select Department","CSE","MCS","HT","BLS","Law","Engineering","Business")
        dep_combo.current(0)
        ...
        course_combo["values"]=("Select course","BSc","BCA","MSc","MCA","B.Tech","M.Tech")
        ...
        reset_btn=Button(btn_frame,text="Reset",command=self.reset_field,width=17,font=("times new roman",13,"bold"),bg="blue",fg="white")
        ...
        img_right = Image.open(r"C:\Program Files\Python311\face_Detaction_project\Images\stdtl.jpeg")
...
#=====================Function declaration========================
        ...
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                if Update>0:
                    conn=mysql.connector.connect(host="localhost",username="root",password="prajapati@1998",database="face_recognition")
                    my_cursor=conn.cursor()
                    my_cursor.execute("update student set Dep=%s, Course=%s, Year=%s, Semester=%s, Student_id=%s, Name=%s, Division=%s,RollNo=%s, Gender=%s, DOB=%s, Email=%s,Phone=%s,Address=%s,Teacher=%s,PhotoSample=%s where Student_id=%s",(
    ...
    def delete_data(self):
        if self.var_std_id.get()=="":
            messagebox.showerror("Error","Student id must bbe required", parent=self.root)
        else:
            try:
    ...
    def generate_dataset(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                for x in myresult:
                    id+=1
                my_cursor.execute("update student set Dep=%s, Course=%s, Year=%s, Semester=%s, Student_id=%s, Name=%s, Division=%s,Phone=%s,Address=%s,Teacher=%s,PhotoSample=%s, Gender=%s, RollNo=%s, DOB=%s, Email=%s where Student_id=%s",(
